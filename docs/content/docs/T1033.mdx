...
<DownloadButton filename="get_user_using_system_info.app" type="app" label="Download Applet" />
...
<DownloadButton filename="get_user_using_environment_variable.app" type="app" label="Download Applet" />
...
<DownloadButton filename="get_user_using_list_folder.app" type="app" label="Download Applet" />
...
<DownloadButton filename="get_user_information_using_system_events_jxa.app" type="app" label="Download Applet" />
