...
<DownloadButton filename="get_system_time.scpt" type="scpt" label="Download .scpt" />
<DownloadButton filename="get_system_time.swift" type="swift" label="Download .swift" />
<DownloadButton filename="get_system_time" type="binary" label="Download Binary" />
<DownloadButton filename="get_system_time.app" type="app" label="Download Application Bundle" />
