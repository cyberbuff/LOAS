...
<DownloadButton filename="copy_apple_notes_database.scpt" type="scpt" label="Download .scpt" />
<DownloadButton filename="copy_apple_notes_database.swift" type="swift" label="Download .swift" />
<DownloadButton filename="copy_apple_notes_database" type="binary" label="Download Binary" />
<DownloadButton filename="copy_apple_notes_database.app" type="app" label="Download Application Bundle" />
