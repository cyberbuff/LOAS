...
### Test #2 - Get microphone input volume
...
<DownloadButton filename="get_microphone_input_volume.scpt" type="scpt" label="Download .scpt" />
<DownloadButton filename="get_microphone_input_volume.swift" type="swift" label="Download .swift" />
<DownloadButton filename="get_microphone_input_volume" type="binary" label="Download Binary" />
<DownloadButton filename="get_microphone_input_volume.app" type="app" label="Download Application Bundle" />

---

### Test #3 - Mute microphone input volume
...
<DownloadButton filename="mute_microphone_input_volume.scpt" type="scpt" label="Download .scpt" />
<DownloadButton filename="mute_microphone_input_volume.swift" type="swift" label="Download .swift" />
<DownloadButton filename="mute_microphone_input_volume" type="binary" label="Download Binary" />
<DownloadButton filename="mute_microphone_input_volume.app" type="app" label="Download Application Bundle" />
