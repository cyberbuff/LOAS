...
### Test #3 - Sleep system (using Finder)

Puts the system to sleep through Finder using AppleScript, matching EggShell tradecraft reported in the wild.
...
<DownloadButton filename="sleep_system_using_finder.scpt" type="scpt" label="Download .scpt" />
<DownloadButton filename="sleep_system_using_finder.swift" type="swift" label="Download .swift" />
<DownloadButton filename="sleep_system_using_finder" type="binary" label="Download Binary" />
<DownloadButton filename="sleep_system_using_finder.app" type="app" label="Download Application Bundle" />
