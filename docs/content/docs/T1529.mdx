...
<DownloadButton filename="shutdown_system_using_system_events.scpt" directory="T1529" type="scpt" label="Download .scpt" />
<DownloadButton filename="shutdown_system_using_system_events.swift" directory="T1529" type="swift" label="Download .swift" />
<DownloadButton filename="shutdown_system_using_system_events" directory="T1529" type="binary" label="Download Binary" />
<DownloadButton filename="shutdown_system_using_system_events.app" directory="T1529" type="app" label="Download .app" />
